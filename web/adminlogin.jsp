<%-- 
    Document   : adminlog
    Created on : 22 Sep, 2017, 9:03:06 PM
    Author     : moule
--%>
...
<div class="form" id="form">
  ...
  <div class="field email">
    <div class="icon"></div>
    <input class="input" id="email" type="text" placeholder="User Name" name="a_user" autocomplete="off"/>
  </div>
  <div class="field password">
    <div class="icon"></div>
    <input class="input" id="password" type="password" name="a_pass" placeholder="Password"/>
  </div>
  <button class="button" id="submit">ADMIN
